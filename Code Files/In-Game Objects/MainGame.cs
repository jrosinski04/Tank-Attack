...
namespace Tank_Attack
{
    public class MainGame
    {
        ...
        {
            player.Velocity = (float)Game1.Vehicles[playerTank].getVelocity();
            player.Firepower = Game1.Vehicles[playerTank].getFirepower();
            player.ArmourBoostEquipped = false;
            player.CamouflageNetEquipped = false;
            player.ReloadTime = Game1.Vehicles[playerTank].getReloadTime();
        ...
        public void Draw(GameTime gameTime)
        {
            ...
            else
            {
                ...
                spriteBatch.DrawString(font12, "Your tank: " + Game1.Vehicles[playerTank].getModel(), new Vector2(10, Game1.windowHeight * 0.97f), Color.Black);
            }
